...
flipoff/
  ...
  css/
    ...
    tile.css           — Tile styling and scramble animation
...
- **Timing**: Tweak `STAGGER_DELAY`, `FLIP_DURATION`, etc.
- **Colors**: Modify `SCRAMBLE_COLORS` and `ACCENT_COLORS`

## Credits

Originally created by [magnum6actual](https://github.com/magnum6actual/flipoff). This fork includes a security and quality audit with fixes for XSS patterns, accessibility, timer bugs, and dead code cleanup.
